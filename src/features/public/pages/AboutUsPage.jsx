...
const AboutUsPage = () => {
  ...
  return (
    <section className="flex flex-col min-h-screen">
      ...
      <HeroSection image={aboutImg} title={"About Us"} />

      {/* why choose us
       */}
      <ContainerComponent className="py-12 space-y-[40px] md:space-y-[80px] lg:space-y-[120px]">
        <div>
        ...
        <div
          className={
            "grid grid-cols-1 md:grid-cols-11 md:gap-[48px] md:items-center"
          }
        >
          <img
            src={Empowering}
        ...
        <div>
          <div className={"text-center"}>
            <h1 className={"text-[25px] font-semibold text-heading mb-1"}>
        ...
        <div
          className={
            "mb-5 grid grid-cols-1 md:grid-cols-11 md:gap-[48px] items-center"
          }
        >
          <img
            src={Facilities}
          ...
          <div className={"col-span-5 space-y-[20px]"}>
            <h1
              className={
                "text-heading font-semibold text-[25px] md:text-[31px] md:font-bold"
              }
            >
              Our Facilities
            </h1>
