  ...
  return (
    <div className="space-y-4 md:space-y-6 lg:space-y-8">
      <div className="space-y-2 md:space-y-3 lg:space-y-4">
        <span className="italic text-secondary text-sm md:text-lg lg:text-2xl font-kite">
          Welcome
        </span>
        ...
        <p className="text-sm md:text-base lg:text-lg font-hind text-para1">
          "Our platform offers expertly crafted courses, personalized learning
          paths, and round-the-clock support to help you reach your goals
          faster."
        </p>
      </div>
      ...
      <PrimaryBtn className="py-2 px-4 md:py-3 md:px-6 rounded text-sm md:text-base lg:text-lg">
        Apply now
      </PrimaryBtn>
    </div>
  );
